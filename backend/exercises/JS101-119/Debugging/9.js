...
function getCompatibleEvents(classes, calendar) {
  function isAvailable(date) {
    ...
    return (!calendar.hasOwnProperty(dateStr)) || (calendar[dateStr].length === 0) ;
  }

  // console.log(isAvailable(toDate("2018-08-16")))
...
getCompatibleEvents(offeredClasses, myCalendar);
